...
public class SysIdRoutine extends SysIdRoutineLog {
  ...
  public static class Config {
    ...
    public Config(
      ...
      m_rampRate = rampRate != null ? rampRate : Volts.of(0.1).per(Second);
      m_stepVoltage = stepVoltage != null ? stepVoltage : Volts.of(0.6);
     ...
     *
     * <p>rampRate: 0.1 volt/sec
     *
     * <p>stepVoltage: 0.6 volts
     *
  ...
  public Command quasistatic(Direction direction) {
    ...
    CommandBase command =
        new WithFinally(
            new InstantCommand(timer::reset, m_mechanism.m_subsystem)
                .andThen(
                    new RunCommand(
                        () -> {
    ...
    command.setName("sysid-" + state + "-" + m_mechanism.m_name);
