...
public class FarRed extends MMOpMode {
    ...
    private final Pose startPose = new Pose(144-55, 8, Math.toRadians(180-90));
    private final Pose endPose = new Pose(144-25, 8);
    ...
    public void buildPaths() {
        MOVE = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(180-90), Math.toRadians(180-90)).build();
    }
