...
public class CloseRed extends MMOpMode {
  ...
  private PathChain
          ...
          INTAKE_3_TO_SHOOT,
          LEAVE;
  private final Pose startPos = new Pose(144-21.000, 123.000, Math.toRadians(180-324));
  private final Pose shoot = new Pose(144-62.000, 76.000, Math.toRadians(180-310));
  Follower follower;
  ...
  public void buildPaths() {
    FRST_SHOOT = follower.pathBuilder().addPath(
            ...
            ).setLinearHeadingInterpolation(Math.toRadians(180-324), Math.toRadians(180-310))
            .build();

    INTAKE_05 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(144-62.000, 76.000),
                            ///       ↓
                            new Pose(144-55.000, 57.000)
                    )
            ).setLinearHeadingInterpolation(Math.toRadians(180-310), Math.toRadians(180-180)).setBrakingStart(1.5)
            .build();
    ...
    INTAKE_1 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(144-55.000, 57.000),
                            ///       ↓
                            new Pose(144-14.000, 55.000)
                    )
            ).setConstantHeadingInterpolation(Math.toRadians(180-180)).setBrakingStart(1.4)
            .build();
    ...
    INTAKE_1_TO_SHOOT = follower.pathBuilder().addPath(
            ...
            ).setLinearHeadingInterpolation(Math.toRadians(180-180), Math.toRadians(180-309)).setBrakingStart(1.5)
            .build();
    ...
    SHOOT_TO_OPEN_05 = follower.pathBuilder().addPath(
                    new BezierLine(
                            shoot,
                            ///       ↓
                            new Pose(144-20.000, 55.000)
                    )
            ).setLinearHeadingInterpolation(Math.toRadians(180-310), Math.toRadians(180-140)).setBrakingStart(1.5)
            .build();

    OPEN_05_TO_OPEN_1 = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(144-17.000, 54.000),
                            ///       ↓
                            new Pose(144-14.000, 60.000)
                    )
            ).setConstantHeadingInterpolation(Math.toRadians(180-140)).setBrakingStart(1.5)
            .build();
    ...
    OPEN_15_TO_SHOOT = follower.pathBuilder().addPath(
                    new BezierLine(
                            new Pose(144-14.000, 56.000),
                            ///       ↓
                            new Pose(144-68.000, 90.000)
                    )
            ).setLinearHeadingInterpolation(Math.toRadians(180-140), Math.toRadians(180-321))
            .build();
