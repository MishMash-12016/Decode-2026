...
/**
 * This class houses static methods to create some common matrices, such as the identity matrix,
 * zero matrix... etc.
 *
...
public class MatrixUtil {
  ...
  /**
   * Takes in an N length 1d array and returns a square matrix of NxN size that has the diagonal
   * elements be the passed in array values while the rest of the elements are 0's
   *
  ...
  /**
   * Returns an affine transformation of 3x3 matrix. This matrix represents a rotation and then a
   * translation
   *
   * @param x x translation
   * @param y y translation
