...
public class PIDController {
  ...
  // The error at the time of the second-most-recent call to calculate() (used to compute error
  // rate)
  ...
  /**
   * Sets the IZone range. When the absolute value of the error is greater than IZone, the total
   * accumulated error will reset to zero, disabling integral gain until the absolute value of the
   * error is less than IZone. This is used to prevent integral windup. Must be non-negative.
   * Passing a value of zero will effectively disable integral gain. Passing a value of {@link
   * Double#POSITIVE_INFINITY} disables IZone functionality.
   *
