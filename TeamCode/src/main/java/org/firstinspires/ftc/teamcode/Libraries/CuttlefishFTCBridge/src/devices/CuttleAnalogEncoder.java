...
public class CuttleAnalogEncoder {
   ...
   * @param maxVoltage Voltage of the sensor in its furthest position in milli-volts. This is
   *     probably the supply voltage of the sensor.
   */
  ...
  /**
   * Get the velocity of the encoder. Will not account for roll over and assumes that this function
   * is being run every at least once every cycle
   */
