...
@AutoLog
@Autonomous
public class CloseRedOpenGate extends MMOpMode {
    ...
    /// consruction|
    private final Pose openGate = new Pose(144-14, 70);
    private final Pose controlPOpenGate = new Pose(144-25, 75);
    /// consruction|
    ...
    public void buildPaths() {
        ...
        FRST_INTAKE_TO_OPEN_GATE = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(180-90)).build();

        OPEN_GATE_TO_SCND_SHOOT = follower.pathBuilder()
                .addPath(new BezierLine(openGate, shoot))
                .setLinearHeadingInterpolation(Math.toRadians(180-90), Math.toRadians(180-136)).build();
        /// constrction
